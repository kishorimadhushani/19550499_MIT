      ...
      <div class="card card-default">
        <div class="card-header">
          ...
          <div class="d-inline-block float-right">
            <a href="<?= base_url('admin/users'); ?>" class="btn btn-success"><i class="fa fa-list"></i> <?= trans('Customers_list') ?></a>
            <a href="<?= base_url('admin/users/add'); ?>" class="btn btn-success"><i class="fa fa-plus"></i> <?= trans('add_new_customer') ?></a>
          </div>
        </div>
        <div class="card-body">
           ...
           <!-- For Messages -->
            ...
            <div class="form-group">
                <label for="customerid" class="col-md-2 control-label"><?= trans('Customer ID') ?></label>

                <div class="col-md-12">
                  <input type="text" name="customerid" value="<?= $customer['customerid']; ?>" class="form-control" id="customerid" placeholder="">
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-12">
                  <input type="text" name="customername" value="<?= $customer['customername']; ?>" class="form-control" id="customername" placeholder="">
                </div>
              </div>
              <div class="form-group">
