      ...
      <div class="card card-default">
        <div class="card-header">
          ...
          <div class="d-inline-block float-right">
            <a href="<?= base_url('admin/users'); ?>" class="btn btn-success"><i class="fa fa-list"></i> </a>
          </div>
        </div>
        <div class="card-body">
           ...
           <!-- For Messages -->
            ...
            <div class="form-group">
                <label for="customerid" class="col-md-2 control-label">Customer ID</label>

                <div class="col-md-12">
                  <input type="number" name="customernameid" class="form-control" id="customerid" placeholder="">
                </div>

              <div class="form-group">
                <label for="customername" class="col-md-2 control-label">Username</label>
