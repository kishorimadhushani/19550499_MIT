                  ...
                  <div class="card">
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="col-md-3">
                          <div class="form-group">
                            <label for="firstname" class="control-label"><?= trans('status') ?></label>
                    ...
                    <div class="card-body">
                       <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <textarea name="termsncondition" class="form-control" rows="3" placeholder="">LNo exchange of products after 7 days of purchase.</textarea>
                        </div>
                    </div>
                  </div>
                </div>
