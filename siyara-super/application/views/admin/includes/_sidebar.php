...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="<?= base_url('admin'); ?>" class="brand-link">
    <img src="http://localhost/imgs/siyaralogo.jpg" alt="Logo" class="brand-image img-circle elevation-3"
         style="opacity: .8">
    <span class="brand-text font-weight-light">Siyara Super City</span>
  </a>
