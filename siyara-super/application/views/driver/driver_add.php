      ...
      <div class="card card-default">
        <div class="card-header">
          ...
          <div class="d-inline-block float-right">
            <a href="<?= base_url('admin/driver'); ?>" class="btn btn-success"><i class="fa fa-list"></i> drivers List</a>
          </div>
        </div>
        <div class="card-body">
           ...
           <!-- For Messages -->
            ...
            <?php echo form_open(base_url('admin/driver/add'), 'class="form-horizontal"');  ?> 
              <div class="form-group">
                <label for="driver_id" class="col-md-2 control-label">driver Id</label>

                <div class="col-md-12">
                  <input type="number" name="driver_id" class="form-control" id="driver_id" placeholder="">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <div class="col-md-12">
                <input type="submit" name="submit" value="Add Driver" class="btn btn-primary pull-right">
                </div>
              </div>
            <?php echo form_close( ); ?>
        </div>
